...
function Header() {
  ...
  const totalQuantity = store.cart.products.reduce((total, item) => total + item.quantity, 0);
        ...
        <div className="d-flex justify-content-center">
          <Link to="/cart" className="link ">
            <div className="Header__cart m-0">
              ...
              <span className="giohang m-0">Giỏ hàng</span>
            </div>
          </Link>

          <Link to={!reduxAuth.isLoggedIn ? "/login" : "/profile"} className="link">
            <button className="Header__login">
              <div className="login__content text-center">
                ...
                <span className="header_login">
                  {!reduxAuth.isLoggedIn ? "Đăng nhập" : `${reduxAuth.user.displayName}`}
                </span>
              </div>
            </button>
          </Link>
